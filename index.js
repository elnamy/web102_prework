...
const str = `A total of $${fundedAmount.toLocaleString('en-US')} has been raised for ${fundedGames} ${fundedGames > 1 ? 'games' : 'game'}. 
Currently, ${unfundedGames} ${unfundedGames > 1 ? 'games' : 'game'}  ${remain} unfounded. We need your help to fund this amazing games!`;
